...
window.translations.en = {
    ...
    // Settings - Server
    port: "Port",
    localApiPortOverride: "Local API Port Override",
    localApiPortOverrideDesc: "Leave empty to follow the current site port for local /v1/messages and /v1/chat/completions URLs.",
    effectivePortLabel: "Effective port: {port}",
    followSitePort: "Follow site port",
    invalidPortOverride: "Port override must be an integer between 1 and 65535",
    optionalApiKey: "Optional",
    apiKeyOptionalDesc: "Leave empty if the server API key is disabled.",
    ...
    todayColon: "Today:",
    hour1Colon: "1H:",
    dailyCapColon: "Daily Cap:",
    minuteCapColon: "RPM Cap:",
    usageTrackedScope: "Tracked:",
    localProxyRequestsOnly: "Local proxy requests only",
    tierSignalsColon: "Tier signals:",
    tierBreakdownColon: "Tier mix:",

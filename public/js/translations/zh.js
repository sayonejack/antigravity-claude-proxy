...
window.translations.zh = {
    ...
    // Settings - Server
    port: "端口",
    localApiPortOverride: "本地 API 端口覆盖",
    localApiPortOverrideDesc: "留空时自动跟随当前网站端口，用于本地 /v1/messages 和 /v1/chat/completions 地址。",
    effectivePortLabel: "当前生效端口：{port}",
    followSitePort: "跟随网站端口",
    invalidPortOverride: "端口覆盖必须是 1 到 65535 的整数",
    optionalApiKey: "可选",
    apiKeyOptionalDesc: "如果服务器未启用 API key，这里可以留空。",
    uiVersion: "UI 版本",
    debugMode: "调试模式",
    environment: "运行环境",
    ...
    dailyCapColon: "日上限:",
    minuteCapColon: "分钟上限:",
    usageTrackedScope: "统计范围:",
    localProxyRequestsOnly: "仅统计本地代理请求",
    tierSignalsColon: "层级信号差异:",
    tierBreakdownColon: "套餐分布:",
    frequentModels: "常用推荐",
